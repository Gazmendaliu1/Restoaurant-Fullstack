...
$sql = "SELECT * FROM products WHERE `type` = 'pasta'";
...
if (mysqli_num_rows($result)>0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class='card  '  '>
            ...
            <a href='' class='btn btn-light add-to-cart-btn' data-name='{$row["name"]}' data-price='{$row["price"]}' data-image='{$row["picture"]}'>Add to cart</a><br>
